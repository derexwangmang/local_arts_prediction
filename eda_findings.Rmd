...
Before conducting an initial split on the data into a training and testing set, we wanted to visualize our outcome variable: `income`. This is a categorical variable with levels indicating the range of the respondent's household income.
...
Below is an representation of the missingness in the local arts data.

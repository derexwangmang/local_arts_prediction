...
Most participants are married, making up the majority in nearly all income brackets. As the number of household members increases, the income increases as well, demonstrating a positive relationship. This makes sense: married participants have their primary source of income as well as their partner's source of income, leading to a higher household income.

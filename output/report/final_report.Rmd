...
We created six models. For each model, we tuned its parameters to identify the parameters that would lead to the best performance. These models and the parameters tuned are below.

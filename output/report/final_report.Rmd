...
We decided to keep one variable that had greater than 20% missingness, specifically `mostimp`, as that question relates to the most important reason the participant did not attend arts events more often and could potentially serve as an important predictor variable.

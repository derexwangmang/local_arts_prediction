...
local_arts_metrics <- metric_set(roc_auc, accuracy)

# apply predicted values to roc_auc to see how our model performed
rf_final_pred %>%
  local_arts_metrics(truth = income, estimate = .pred_class, `.pred_Under $10,000`, `.pred_$10,000 to $14,999`, `.pred_$15,000 to $19,999`,
